...
class RendimientoActivity : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val TASA_DIARIA_1 = (TASA_DE_INTERES_1 / 360) / 100
        val RENDIMIENTO_1 = MONTO_1 * TASA_DIARIA_1 * PLAZO_1
        val CAPITAL_INICIAL_1 = MONTO_1
        val CAPITAL_FINAL_1 = MONTO_1 + RENDIMIENTO_1
        val ROI_1 = (CAPITAL_FINAL_1 - CAPITAL_INICIAL_1) / CAPITAL_INICIAL_1 * 100
        ...
        val TASA_DIARIA_2 = (TASA_DE_INTERES_2 / 360) / 100
        val RENDIMIENTO_2 = MONTO_1 * TASA_DIARIA_2 * PLAZO_2
        val CAPITAL_INICIAL_2 = MONTO_2
        val CAPITAL_FINAL_2 = MONTO_2 + RENDIMIENTO_2
        val ROI_2 = (CAPITAL_FINAL_2 - CAPITAL_INICIAL_2) / CAPITAL_INICIAL_2 * 100
